...
- Aster keeps new app/frontend UI visually consistent unless a project-specific brand overrides it.
...
9. For app/frontend projects, Codex applies Aster by reading `resources/branding/aster/BRAND.md` and importing or copying `aster-tokens.css`.
10. For managed code projects, Codex prepares Graphify after repo and ignore rules are safe.
11. Codex executes from Linear issues.
12. Codex updates `MEMORY.md` only when durable context changes.
